...
const FeedbackCard = ({index,testimonial,name,designation,company,image}) =>(
  <motion.div variants={fadeIn("","spring",index * 0.5,0.75)} className='bg-black-200 p-10 rounded-3xl es:w-[320px] w-full'>
...
const Feedbacks = () => {
  return (
    <div className="mt-12 bg-black-100 rounded-full">
